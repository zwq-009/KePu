<template>
	<view>
		<view class="v1">
			<text>请填写用户名：</text><input type="text" v-model="phoneNumber" />
			<text>请填写密码：</text><input password="Boolean" maxlength="8" v-model="password" />
		</view>
		<view class="v2">
			<button @click="account_loginFc()">注册</button>
			<button @click="goDetail()" class="b1">去登陆</button>
		</view>
